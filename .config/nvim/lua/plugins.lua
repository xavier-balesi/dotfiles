...
require('packer').startup({
    function()
        ...
        use {
            ...
            requires = { 'nvim-lualine/lualine.nvim', 'kyazdani42/nvim-web-devicons', 'linrongbin16/lsp-progress.nvim' },
        ...
        use({
            ...
            config = function()
                ...
                vim.keymap.set('n', 'gli', '<CMD>Glance implementations<CR>')
            end,
        })
        -- use {
        --   'neoclide/coc.nvim',
        ...
        -- it causes failure after auto-session update
        -- use {
